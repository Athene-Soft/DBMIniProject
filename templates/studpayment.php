<?php include("includes/header.php");  ?>
    ...
    <div class="tile-area tile-area-scheme-dark fg-white">
        <h1 class="tile-area-title">Student Payment</h1>
        ...
        <div class="margin40">
            <div class="grid">
                <div class="row cells12" >
                    <div class="cell colspan4" style="float: left">
                    ...
                    <div class="cell colspan6">
                        ...
                        <div>
                            ...
                            <br>
                            <br>
                            <label>Instructor:</label><label style="margin-left: 10px"></label><label>VALUE</label>
                            <br>
                            <br>
                        ...
                        <div style="margin-top:20px">
                            ...
                            <div class="inline" style="float: left;margin-right:10px">                               
                                <button id="" onclick="">Payment Recieved</button>
                            </div>
                            <div class="inline" style="float: left;margin-right:10px">
